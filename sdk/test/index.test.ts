...
test("test token list", () => {
    expect(TOKENS).toHaveLength(MAX_TOKEN_LIST_LENGTH);

    for (const token of [NATIVE_TOKEN_ADDRESS, ERC20_FIRST_ADDRESS, ERC20_SECOND_ADDRESS, TOKEN_WRAPPER_ADDRESS]) {
